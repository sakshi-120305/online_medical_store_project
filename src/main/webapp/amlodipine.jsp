      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.jsp">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.jsp">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Amlodipine-5mg</strong>
            </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/amlodipine-5mg-tablet.jpg" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Amlodipine-5mg</h2>
            <p>Amlodipine is used alone or together with other medicines to treat hypertension 
              (high blood pressure). High blood pressure adds to the workload of the heart and arteries.
               If it continues for a long time, the heart and arteries may not function properly.</p>
            <strong class="text-primary h4">RS. 10.00</strong></p>

            
            
            
            <p><a href="cart.jsp" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary"
              onclick="addToCartAndNavigate('Amlodipine-5mg', 10.00, 'images/amlodipine-5mg-tablet.jpg')">
              Add To Cart</a></p>
