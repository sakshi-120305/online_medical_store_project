      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.jsp">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.jsp">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Nivea Bodylotion</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/Nivia Bodylotion.jpg" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Nivea Bodylotion</h2>
            <p>Body lotions are formulated to support the skin barrier and prevent moisture 
             evaporation, keeping the skin hydrated, soft, and smooth.Look for formulas like our NIVEA Express
             Hydration Body Lotion, which provides fast-absorbing moisture, ideal for the summer months.</p>
            <strong class="text-primary h4">RS. 85.00</strong></p>

           
            <p><a href="cart.jsp" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary"
              onclick="addToCartAndNavigate('Nivea Bodylotion', 85.00, 'images/Nivia Bodylotion.jpg')">
              Add To Cart</a></p>
                  ...
                  <table class="table custom-table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="bg-light">March 2026</td>
                      </tr>
                      <tr>
                        <td>MEDICATION ROUTE</td>
                        <td class="bg-light">Topical (applied to the skin)</td>
                      </tr>
                    </tbody>
                  </table>
