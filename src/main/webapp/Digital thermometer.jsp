      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.jsp">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.jsp">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Digital thermometer</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/Digital thermometer.jpg" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Digital thermometer</h2>
            <p>Digital thermometers can be used to record temperatures from the mouth, armpit or rectum. 
                Armpit temperatures are the least accurate. Rectal temperatures provide the most accurate 
                readings for children between 3 months and 3 years of age.</p>
            ...
            <p><a href="cart.jsp" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary"
              onclick="addToCartAndNavigate('Digital thermometer', 50.00, 'images/Digital thermometer.jpg')">
              Add To Cart</a></p>
                  ...
                  <table class="table custom-table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="bg-light">Sep 2027</td>
                      </tr>
                      <tr>
                        <td>MEDICATION ROUTE</td>
                        <td class="bg-light">orally,rectally,axillary(under the armpit)</td>
                      </tr>
                    </tbody>
                  </table>
