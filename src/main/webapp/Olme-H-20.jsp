...
<body>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3"  style="margin-top:130px">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.jsp">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.jsp">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Olme-H-20</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/Olme-H-20.jpg" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Olme-H-20</h2>
            <p>Olme H 20 Tablet is primarily used to treat high blood pressure. 
              Olme H 20 Tablet is a combination of two medicines: Olmesartan and Hydrochlorothiazide. 
              Olmesartan medoximil is a prodrug and breaks down into active form, i.e., olmesartan once absorbed 
              in the GIT (Gastrointestinal tract). It is an angiotensin receptor blocker (ARB) that blocks the 
              hormone angiotensin and relaxes blood vessels. </p>
            <strong class="text-primary h4">RS. 60.00</strong></p>

           
            <p><a href="cart.jsp" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary" 
                onclick="addToCartAndNavigate('Olme-H-20', 60.00, 'images/Olme-H-20.jpg')">
                Add To Cart</a></p>
                ...
                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                  ...
                  <table class="table custom-table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>EXPIRES ON OR AFTER</td>
                        <td class="bg-light">oct 2027</td>
                      </tr>
                      <tr>
                        <td>MEDICATION ROUTE</td>
                        <td class="bg-light">Oral</td>
                      </tr>
                    </tbody>
                  </table>
