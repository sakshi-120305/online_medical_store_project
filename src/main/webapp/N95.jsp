      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.jsp">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.jsp">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">N95 mask</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/N95 mask.jpg" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">N95 mask</h2>
            <p>An N95 mask protects you from breathing in small particles in the air such as dust and mold. 
                It is designed to filter out at least 95% of the dust and mold in the air It is also effective 
                against biological particles such as pollen, mold spores, bacteria, viruses, animal dander and 
                allergens.</p>
            <strong class="text-primary h4">RS. 20.00</strong></p>

           
            <p><a href="cart.jsp" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary"
              onclick="addToCartAndNavigate('N95 mask', 20.00, 'images/N95 mask.jpg')">
              Add To Cart</a></p>
                  ...
                  <table class="table custom-table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="bg-light">Aug 2027</td>
                      </tr>
                      <tr>
                        <td>MEDICATION ROUTE</td>
                        <td class="bg-light">Respiratory protection device</td>
                      </tr>
                    </tbody>
                  </table>
