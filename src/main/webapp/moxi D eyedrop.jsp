      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.jsp">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.jsp">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">moxi D eyedrop</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/moxi D eyedrop.jpg" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">moxi D eyedrop</h2>
            <p>Moxi D Eye Drop is used to treat bacterial infection of the eyes such as conjunctivitis or pink eye. 
                It stops the growth of bacteria causing infection and helps relieve pain, swelling, redness, 
                itching or irritation in the eyes. Use it 2-3 times a day for atleast a week or as prescribed by the 
                doctor.</p>
            ...
            <p><a href="cart.jsp" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary"
              onclick="addToCartAndNavigate('moxi D eyedrop', 50.00, 'images/moxi D eyedrop.jpg')">
              Add To Cart</a></p>
                  ...
                  <table class="table custom-table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="bg-light">July 2026</td>
                      </tr>
                      <tr>
                        <td>MEDICATION ROUTE</td>
                        <td class="bg-light">Ophthalmic route</td>
                      </tr>
                    </tbody>
                  </table>
