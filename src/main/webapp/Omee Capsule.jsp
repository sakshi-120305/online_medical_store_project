      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.jsp">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.jsp">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Omee Capsule</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/Omee-Capsule.jpg" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Omee Capsule</h2>
            <p>Omee Capsule is a medicine that reduces the amount of acid produced in your stomach.
                It is used in the treatment of acid-related diseases of the stomach and intestine 
                such as heartburn, acid reflux, peptic ulcer disease, and Zollinger-Ellison syndrome. 
                It provides relief from symptoms and promotes healing.</p>
            <strong class="text-primary h4">RS. 40.00</strong></p>

           
            <p><a href="cart.jsp" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary"
              onclick="addToCartAndNavigate('Omee Capsule', 40.00, 'images/Omee-Capsule.jpg')">
              Add To Cart</a></p>
                  ...
                  <table class="table custom-table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="bg-light">June 2026</td>
                      </tr>
                      <tr>
