      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.jsp">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.jsp">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Thyroxine sodium 50 mcg</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/Thyroxine Sodium 50 Mcg.jpg" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6" >
            <h2 class="text-black">Thyroxine sodium 50 mcg</h2>
            <p>Thyroxine Sodium belongs to 'thyroid agents', primarily used to treat underactive
                thyroid (hypothyroidism). Hypothyroidism is a chronic disorder, which happens when 
                the thyroid gland (located in the front lower part of the neck), is unable to make enough 
                thyroid hormone.</p>
            ...
            <p><a href="cart.jsp" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary"
             onclick="addToCartAndNavigate('Thyroxine sodium 50 mcg', 50.00, 'images/Thyroxine Sodium 50 Mcg.jpg')">
             Add To Cart</a></p>
