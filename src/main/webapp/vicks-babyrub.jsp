      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.jsp">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.jsp">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">vicks-babyrub</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/vicks-babyrub.jpg" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Vicks-Babyrub</h2>
            <p>It is specially formulated to soothe, moisturise and relax the baby gently. Composed of fragrances 
              like Lavender, Eucalyptus & Rosemary, it is the perfect choice to provide a calming effect if your 
              baby is fussy and irritable due to cold and cough. The rub also helps your baby relax and 
              get rid of a congested nose.</p>
            <strong class="text-primary h4">RS. 50.00</strong></p>

           
            <p><a href="cart.jsp" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary"
              onclick="addToCartAndNavigate('vicks-babyrub', 50.00, 'images/vicks-babyrub.jpg')">
              Add To Cart</a></p>
                  ...
                  <table class="table custom-table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="bg-light">Feb 2027</td>
                      </tr>
                      <tr>
                        <td>MEDICATION ROUTE</td>
                        <td class="bg-light">Inhalation</td>
                      </tr>
                    </tbody>
                  </table>
