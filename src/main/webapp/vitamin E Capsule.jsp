      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.jsp">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.jsp">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">vitamin E Capsule</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/vitamin E.jpg" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Vitamin E Capsule</h2>
            <p>Vitamin E capsules treat low levels of vitamin E in your body.This vitamin protects your
              cells and maintains the health of your organs. You can take these capsules or tablets 
              by mouth with a glass of water as directed. This medication may work best when you take 
              it with food.</p>
            <strong class="text-primary h4">RS. 35.00</strong></p>

           
            <p><a href="cart.jsp" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary"
              onclick="addToCartAndNavigate('vitamin E Capsuler', 35.00, 'images/vitamin E.jpg')">
              Add To Cart</a></p>
