      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.jsp">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.jsp">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Ayusas cough syrup</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/Ayusas cough syrup.jpg" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Ayusas cough syrup</h2>
            <p>Ayusas cough syrup is used to treat coughs, colds, sore throats, and bronchitis. It can 
                help relieve dry and wet coughs, dissolve phlegm, and promote easy breathing.Boosts body's natural immunity
                Non-drowsy and non-alcoholic formulation,Paraben free and child safe </p>
            <strong class="text-primary h4">RS. 90.00</strong></p>

           
            <p><a href="cart.jsp" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary"
              onclick="addToCartAndNavigate('Ayusas cough syrup', 90.00, 'images/Ayusas cough syrup.jpg')">
              Add To Cart</a></p>
