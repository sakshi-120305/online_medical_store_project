      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.jsp">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.jsp">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Alkof orange syrup</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/Alkof orange syrup.jpg" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Alkof orange syrup</h2>
            <p>Alkof Syrup Orange relieves cough associated with bronchitis, bronchial asthma, 
                emphysema and other broncho-pulmonary disorders. It may cause dizziness and sleepiness. 
                Do not drive or do anything that requires mental focus until you know how it affects you.</p>
            ...
            <p><a href="cart.jsp" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary "
              onclick="addToCartAndNavigate('Alkof orange syrup', 50.00, 'images/Alkof orange syrup.jpg')">
              Add To Cart</a></p>
