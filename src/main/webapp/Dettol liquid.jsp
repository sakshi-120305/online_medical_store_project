      ...
      <div class="container" style="margin-top:130px">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.jsp">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.jsp">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Dettol liquid</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="images/dettol liquid.jpg" alt="Image" class="img-fluid p-5">
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black">Dettol liquid</h2>
            <p>Dettol Liquid Antiseptic Disinfectant is a proven effective concentrated antiseptic disinfectant
               that kills bacteria and provides protection against bacteria which can cause infection and illness.
               It can be used for gentle antiseptic wound cleansing and disinfection and antiseptic skin cleansing.</p>
            <strong class="text-primary h4">RS. 80.00</strong></p>

           
            <p><a href="cart.jsp" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary"
              onclick="addToCartAndNavigate('Dettol liquid', 80.00, 'images/dettol liquid.jpg')">
              Add To Cart</a></p>
                  ...
                  <table class="table custom-table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="bg-light">Nov 2026</td>
                      </tr>
                      <tr>
                        <td>MEDICATION ROUTE</td>
                        <td class="bg-light">Antiseptic disinfectant</td>
                      </tr>
                    </tbody>
                  </table>
